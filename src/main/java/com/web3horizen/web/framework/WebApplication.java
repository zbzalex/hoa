...
import com.web3horizen.web.framework.annotation.*;
import com.web3horizen.web.framework.mvc.Controller;
...
public class WebApplication extends HttpServlet implements Application {
    ...
    public void processController(Class<?> controllerClass) {
        com.web3horizen.web.framework.annotation.Controller controllerAnnotation = controllerClass.getDeclaredAnnotation(com.web3horizen.web.framework.annotation.Controller.class);
